...
const files = fs.readdirSync(soundAssetsDir).filter((file) => file.endsWith('.mp3'));
...
fs.writeFileSync(path.join(projectRoot, 'constants', 'generated', 'Clips.ts'), `// Generated by scripts/update-audio-clips.ts\n\n${imports}\n${exports}`);